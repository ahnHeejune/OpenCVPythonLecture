...
if __name__ == '__main__':
    ...
    print("Calculating PCA, Be patient It take some time")    
    print("", end = "...")
    mean, eigenVectors = cv2.PCACompute(data, mean = None, maxComponents = NUM_EIGEN_FACES)
    print ("DONE")

    averageFace = mean.reshape(sz)
    print(f"averageFace: shape: {averageFace.shape}, type: {averageFace.dtype}, min:{mean.min()}, max:{mean.max()} ")
